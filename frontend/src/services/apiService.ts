...
class ApiService {
  ...
  public async getAdminUsers(): Promise<AdminUserResponse[]> {
    const response: AxiosResponse<AdminUserResponse[]> = await this.api.get('/admin/users');
    return response.data;
  }

  public async createAdminUser(user: AdminUserCreateRequest): Promise<AdminUserResponse> {
    const response: AxiosResponse<AdminUserResponse> = await this.api.post('/admin/users', user);
    return response.data;
  }
